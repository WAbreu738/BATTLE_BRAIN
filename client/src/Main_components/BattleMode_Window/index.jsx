...
import { useStore } from "../Options"; //GlobalState
  ...
  return (
    <main className="flex flex-col items-center justify-center h-screen p-4 ">
      {countdown > 0 ? (
        ...
        <div className="relative bg-purple-900 bg-opacity-80 shadow-lg rounded-lg p-10 max-w-4xl w-full">
          <Timer
            timeLeft={timeLeft}
          ...
          {currentQuestion && <p>{currentQuestion.region}</p>}
